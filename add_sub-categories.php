					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "INSERT INTO subcategory(c_id,title,image) VALUE('".$_POST['c_name']."','".$res_name."','".$fnew."')";  // store the submited data ino the database :images
												mysqli_query($db, $sql); 
            ...
            <div class="container-fluid">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add Sub-categories</h4>
                            </div>
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="add_sub-categories.php" class="btn btn-inverse">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
