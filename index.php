                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Choose Categoriess</h4> </div>
                
                        <div class="step-item step2">
                        <i class="fa fa-gift" aria-hidden="true" style="font-size:30px;margin-bottom :10px;"></i>
                            

                            <h4><span style="color:white;">2. </span>Order Gifts</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Popular Gifts of the Month</h2>
                    <p class="lead">Easiest way to order your favourite Gift among these top 6 gift</p>
                </div>
                <div class="row">
						<?php 					
						$query_res= mysqli_query($db,"select * from all_gifts LIMIT 6"); 
                                while($r=mysqli_fetch_array($query_res))
                                {
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    <h5 ><a href="gifts.php?res_id='.$r['rs_id'].'">'.$r['title'].'</a></h5>
                                                    <div class="product-name" style="display: block;/* or inline-block */
                                                    text-overflow: ellipsis;
                                                    word-wrap: break-word;
                                                    overflow: hidden;
                                                    max-height: 3.6em;
                                                    line-height: 1.8em;">'.$r['slogan'].'</div>
                                                    <div class="price-btn-block"> <span class="price">Rs'.$r['price'].'</span> <a href="gifts.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                                </div>
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Choose a Categoriess</h3>
                                    <p>We"ve got your covered with gifts from a variety of delivery  online.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <i class="fa fa-gift" aria-hidden="true" style="font-size:30px;color:white;padding-top:25px"></i>
                                </div>
                                <h3>Choose a Gift</h3>
                                <p>We"ve got your covered with a variety of delivery gift online.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Get your gifts delivered! And enjoy your day! </p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="restaurant-listing">
						...
						<?php  
						$ress= mysqli_query($db,"select * from subcategory");  
														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" href="gifts.php?res_id='.$rows['rs_id'].'" > <img src="admin/Res_img/'.$rows['image'].'" alt="Restaurant logo" style="width:60px;height:60px;"> </a>
																</div>
