...
<header id="header" class="header-scroll top-header headrom">
        ...
        <div class="page-wrapper">
            ...
            <div class="inner-page-hero bg-image" style="align-item:center;display:flex;justify-content:center">
                <h1>Thank You</h1>
            ...
            <section class="restaurants-page" style="overflow-x:auto;">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                          </div>
														 ...
														 <td data-column="Item"> <?php echo $row['title']; ?></td>
														  ...
														  <td data-column="Date"> <?php echo $row['date']; ?></td>
														   <td data-column="Action"> <a href="delete_orders.php?order_del=<?php echo $row['o_id'];?>" onclick="return confirm('Are you sure you want to cancel your order?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
															<!-- </td>
															<td data-column="Action"  style="padding-top:25px;"> <a href="#" style="background-color:lightblue;padding:10px 15px;" ><i class="fa fa-file" aria-hidden="true" style="font-size:16px"></i></a> 
															</td> -->
